export default function Department() {
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
      ...
      <header className="w-full bg-gradient-to-r from-orange-300 to-red-500 p8 text-center">
        <h1 className="text-4xl font-extrabold capitalize tracking-tighter md:text-5xl">Department</h1>
        <p className="mt-2 text-lg md:text-xl">Explore our specialized departments and their unique offerings</p>
      </header>
      {/* Main Content */}
      <main className="w-full max-w-6xl px-6 py-10">
        {/* Department Overview Section */}
        <section className="mb-12">
          <h2 className="text-3xl font-semi bold mb-4 border-b-2 border-orange-600 pb-2">
            Overview
          </h2>
          <p className="text-gray-400">
            Our college  is  homw to multiple depart ments th at focus on providing
        ...
        <section>
          ...
          <p className="text-gray-400 mb-6">
            For any queries about our departments, feel free to reach out to us via email or phone. We're email to assist you.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           

            <div className="p6 bg-gray-800 rounded-lg shadow-md hover:shadow-lg hover:scale-105 transform trasition-all">
              <h3 className="text-xl font-bold text-orange-500">Email</h3>
              <p className="mt-2 text-sm text-gray-400">department@college.edu</p>
            </div>

            <div className="p-6 bg-gray-800 rounded-lg shadow-md hover:shadow-lg hover:scale-105 transform transition-all">
              <h3 className="text-xl font-bold text-gray-400">Phone</h3>
